...
for %%a in ( "*.dat", "*.ldr" ) do %LDVIEW_EXE% "%%a" "-SaveSnapshot=%%~na.bmp" -PreferenceSet=DifferentSettings -SaveActualSize=0 -SaveImageType=2 -SaveZoomToFit=1 -SaveWidth=640 -SaveHeight=480 -DefaultZoom=0.95 -FOV=10 -DefaultMatrix=0.662151,0.052753,0.747509,0.501881,0.709535,-0.494645,-0.556478,0.70269,0.443344
