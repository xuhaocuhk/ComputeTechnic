...
for %%a in ( "*.dat", "*.ldr" ) do %LDVIEW_EXE% "%%a" "-SaveSnapshot=%%~na.bmp" -PreferenceSet=render_setting -SaveActualSize=0 -SaveImageType=1 -SaveZoomToFit=1 -SaveWidth=800 -SaveHeight=600 -DefaultZoom=0.95 -FOV=10 -DefaultMatrix=0.387697,-0.90394,-0.1805,-0.507513,-0.0458616,-0.860423,0.769494,0.425191,-0.476544
